...
New-NetFirewallRule -DisplayName "ALLOW UDP PORT 1541, 1560-1591 1cv83" -Direction inbound -Profile Any -Action Allow -LocalPort 1541, 1560-1591 -Protocol UDP
New-NetFirewallRule -DisplayName "ALLOW TCP PORT 1541, 1560-1591 1cv83" -Direction inbound -Profile Any -Action Allow -LocalPort 1541, 1560-1591 -Protocol TCP
